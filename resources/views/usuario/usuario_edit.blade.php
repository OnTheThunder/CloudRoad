                    ...
                    <div id="buscador" class="row">
                        ...
                        <div class="col-6">
                            ...
                            <div class="form-group row p-3 ">
                                ...
                                <input type="radio" class=" col-1 ml-2 mt-1" name="activo" value="2" checked>Ambos
                                <input type="radio" class=" col-1 ml-2 mt-1" name="activo" value="1">Activo
                                <input type="radio" class=" col-1 ml-2 mt-1" name="activo" value="0">No activo
                            </div>
                        </div>
